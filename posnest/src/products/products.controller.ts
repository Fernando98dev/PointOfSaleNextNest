import { Controller, Get, Post, Body, Patch, Param, Delete, Query, BadRequestException, UploadedFile, UseInterceptors } from '@nestjs/common';
...
export class ProductsController {
  ...
  findAll(@Query() query: GetProductQueryDto) {
    ...
    return this.productsService.findAll(categoryId ? +categoryId : null, take, skip);
  }
